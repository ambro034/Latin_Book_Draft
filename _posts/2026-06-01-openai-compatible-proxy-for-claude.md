...
excerpt: >
  ...
  to OpenAI can point at it and get Claude instead — zero client changes. Here's
...
— less model magic, more boring engineering.)
...
no leaked stack traces — the difference between "works on my laptop" and "survives a
